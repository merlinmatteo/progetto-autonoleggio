...
<body>
    ...
    <div class="navbar">
        <nav>
            <ul>
                <li><a href="prenotClient.php" class="nav-button">Le Mie Prenotazioni</a></li>
                <li><a href="index.php" class="nav-button">Logout</a></li>
            </ul>
        </nav>
    </div>
            ...
            <div class="products-grid">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="prenota.php?marca=' . urlencode($row['marca']) . '&modello=' . urlencode($row['modello']) . '" class="btn-prenota">Prenota</a>';
                        echo '</div>';
                    }
                } else {
